...
constexpr const char *kSkippedMessages[] = {
    ...
    // VMA is used to allocate buffer memory, and it's not checking the result of
    // vkGetBufferMemoryRequirements against the heap size before attempting to make an allocation.
